...
|----|------|--------|---------------------|
| T-000 | Create GitHub repo `musify` | XS | Repo exists, `main` branch, MIT LICENSE, .gitignore for Python + Node |
...
| T-076 | Implement download manager (mobile) | XL | Tap download → progress bar → file saved to `/storage/musify/audio/{video_id}.webm` |
...
| B-008 | Voice control | "Hey Musify, play something chill" |
