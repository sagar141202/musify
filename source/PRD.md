# Musify — Product Requirements Document
...
**Musify** is a personal, self-hosted music streaming app for Android that streams any song from YouTube instantly — with album art, time-synced lyrics, AI recommendations, and offline downloads — at zero cost and with zero ads, forever.
...
Musify solves every single one of these gaps. It is built for personal use only, runs on a home server or free cloud tier, and gives a premium experience that rivals or exceeds paid services.
